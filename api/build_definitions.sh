...
npm install
node_modules/protobufjs/bin/pbjs ../src/main/resources/yaas_model.proto  > model.json
node_modules/protobufjs/bin/pbjs ../src/main/resources/yaas_model.proto -t js > model.js
node_modules/proto2typescript/bin/proto2typescript-bin.js --file model.json > model.d.ts
node_modules/@mroylance/protobuftshelper/run.sh model.js model_factories.ts ./model.d.ts YaasModel
rm -rf model.json
rm -rf model.js
popd
