...
class AdminService(
    ...
    override fun change_password_for_user(request: org.roylance.yaas.YaasModels.UIRequest): org.roylance.yaas.YaasModels.UIResponse {
    ...
    override fun get_all_users(request: org.roylance.yaas.YaasModels.UIRequest): org.roylance.yaas.YaasModels.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun is_user_admin(request: org.roylance.yaas.YaasModels.UIRequest): org.roylance.yaas.YaasModels.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun set_user_as_admin(request: org.roylance.yaas.YaasModels.UIRequest): org.roylance.yaas.YaasModels.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun remove_user_as_admin(request: org.roylance.yaas.YaasModels.UIRequest): org.roylance.yaas.YaasModels.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun delete_user(request: org.roylance.yaas.YaasModels.UIRequest): org.roylance.yaas.YaasModels.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
