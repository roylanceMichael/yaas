...
class AuthenticationService(
    ...
    override fun exists(request: org.roylance.yaas.YaasModel.UIRequest): org.roylance.yaas.YaasModel.UIResponse {
    ...
    override fun login(request: org.roylance.yaas.YaasModel.UIRequest): org.roylance.yaas.YaasModel.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun authenticate(request: org.roylance.yaas.YaasModel.UIRequest): org.roylance.yaas.YaasModel.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun register(request: org.roylance.yaas.YaasModel.UIRequest): org.roylance.yaas.YaasModel.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
    ...
    override fun change_password(request: org.roylance.yaas.YaasModel.UIRequest): org.roylance.yaas.YaasModel.UIResponse {
        val base64request = protoSerializer.serializeToBase64(request)
