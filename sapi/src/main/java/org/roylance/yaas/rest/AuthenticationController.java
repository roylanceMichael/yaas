...
public class AuthenticationController {
    ...
    public void exists(@Suspended AsyncResponse asyncResponse, String request) throws Exception {
        new Thread(() -> {
            ...
            final org.roylance.yaas.YaasModels.UIResponse response = this.authenticationService.exists(requestActual);
    ...
    public void login(@Suspended AsyncResponse asyncResponse, String request) throws Exception {
        new Thread(() -> {
            ...
            final org.roylance.yaas.YaasModels.UIResponse response = this.authenticationService.login(requestActual);
            final String deserializeResponse = this.serializerService.serializeToBase64(response);
            asyncResponse.resume(deserializeResponse);
    ...
    public void authenticate(@Suspended AsyncResponse asyncResponse, String request) throws Exception {
        new Thread(() -> {
            ...
            final org.roylance.yaas.YaasModels.UIResponse response = this.authenticationService.authenticate(requestActual);
            final String deserializeResponse = this.serializerService.serializeToBase64(response);
            asyncResponse.resume(deserializeResponse);
    ...
    public void register(@Suspended AsyncResponse asyncResponse, String request) throws Exception {
        new Thread(() -> {
            ...
            final org.roylance.yaas.YaasModels.UIResponse response = this.authenticationService.register(requestActual);
            final String deserializeResponse = this.serializerService.serializeToBase64(response);
            asyncResponse.resume(deserializeResponse);
    ...
    public void change_password(@Suspended AsyncResponse asyncResponse, String request) throws Exception {
        new Thread(() -> {
            ...
            final org.roylance.yaas.YaasModels.UIResponse response = this.authenticationService.change_password(requestActual);
            final String deserializeResponse = this.serializerService.serializeToBase64(response);
            asyncResponse.resume(deserializeResponse);
    ...
    public void save(@Suspended AsyncResponse asyncResponse, String request) throws Exception {
        new Thread(() -> {
            ...
            final org.roylance.yaas.YaasModels.UIResponse response = this.authenticationService.save(requestActual);
            final String deserializeResponse = this.serializerService.serializeToBase64(response);
            asyncResponse.resume(deserializeResponse);
